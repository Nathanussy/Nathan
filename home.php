...
<body>
  <h1 class="mt-4" style="color:#fff">Heloo</h1>
  <ol class="breadcrumb mb-8">
    <li class="m-0" style="color:#fff"><?= $_SESSION["user"]["nama"]; ?></li>
  </ol>

  <h1 class="mt-4 text-center" style="color:#fff">Popular choices</h1>
  ...
  <div class="container-fluid d-flex justify-content-between mt-3">
    <div style="display: flex; justify-content: flex-end; align-items: right;">
      <a href="logout_user.php">
        <i class="bi bi-box-arrow-left" style="margin-right:30px; color:#eddcfc;"></i>
      </a>
    </div>
  </div>
